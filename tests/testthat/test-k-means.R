test_that("K-Means works", {
  ...
  testthat::expect_no_error(kMeans(data,K=3,distance = 'euclidean'))
  testthat::expect_no_error(kMeans(data,K=3,distance = 'maximum'))
  testthat::expect_no_error(kMeans(data,K=3,distance = 'Lp', p=1.5))
  testthat::expect_no_error(kMeans(data,K=3,distance = 'Lp', p=10))
  testthat::expect_no_error(kMeans(data,K=3,distance = 'manhattan'))
