...
```{r}
set.seed(123)
clustering_1 <- kMedioids(data_1,K=5, distance = 'euclidean')
set.seed(123)
clustering_2 <- kMedioids(data_1,K=5, distance = 'maximum')
set.seed(123)
clustering_3 <- kMedioids(data_1,K=5, distance = 'manhattan')
```
