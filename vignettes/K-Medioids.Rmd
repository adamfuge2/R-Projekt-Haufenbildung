...
kMedioids(data_3,K=3,custom_metric = study_courses_distance)$clustered_data
...
clustering
viewClusters(generateFullTestData(n=4000,min = c(-180,-90), max=c(180,90)),clustering$clustering_function)
```
