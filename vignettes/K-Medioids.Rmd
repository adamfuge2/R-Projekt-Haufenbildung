...
K-Medioids can be used to find the right cluster amount. 
...
kMedioids(data_5,K=3)
kMedioids(data_1,K=1,.print_info = TRUE)
kMedioids(data_3,K=3,custom_distance_function = study_courses_distance)$clustered_data
kMedioids(numbers_and_characters,K=3,custom_distance_function = numericAndCharacterMixedDistance)
```
...
### p = 1 (manhattan)
```{r p_examples_1}
f <- kMedioids(data_5,K=4, distance_method = 'minkowski', p=1)$clustering_function
